...
export default function WhatsAppButton() {
  const handleWhatsAppClick = () => {
    const phoneNumber = '6285726112001' // WhatsApp number
    const message = encodeURIComponent('Halo, saya ingin bertanya tentang layanan PT. Akademi Profesional Indonesia.')
